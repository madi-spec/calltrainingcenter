...
function IntegrationCard({ integration, onDisconnect }) {
  ...
  return (
    <div className="flex items-center justify-between p-4 bg-white dark:bg-card rounded-lg border border-border dark:border-border">
      <div className="flex items-center gap-4">
        {getProviderIcon(integration.provider)}
        <div>
          <div className="flex items-center gap-2">
            <h4 className="font-medium text-foreground dark:text-foreground capitalize">
  ...
  if (loading) {
    return (
      <div className="animate-pulse space-y-4">
        <div className="h-16 bg-muted dark:bg-muted rounded-lg"></div>
        <div className="h-16 bg-muted dark:bg-muted rounded-lg"></div>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      {integrations.length > 0 && (
        <div className="space-y-3">
          <h4 className="text-sm font-medium text-muted-foreground dark:text-secondary-foreground">
            Connected Calendars
          </h4>
      ...
      <div className="space-y-3">
        ...
        {!hasGoogle && (
          <button
            ...
            className="w-full flex items-center justify-center gap-3 p-4 bg-white dark:bg-card rounded-lg border border-border dark:border-border hover:border-primary-500 dark:hover:border-primary-500 transition-colors disabled:opacity-50"
          >
            <svg className="w-6 h-6" viewBox="0 0 24 24">
              <path fill="#4285F4" d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z"/>
              <path fill="#34A853" d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z"/>
      ...
      <div className="p-4 bg-muted dark:bg-muted/50 rounded-lg">
        ...
        <ul className="mt-2 text-sm text-muted-foreground dark:text-muted-foreground space-y-1">
