              ...
              <div className="space-y-3">
                    ...
                    return (
                      <button
                        ...
                        className={`
                          ...
                          ${isSelected ? getColorClasses(type.color) : 'text-muted-foreground bg-muted hover:bg-muted'}
                        `}
                      >
                ...
                <div className="flex items-center gap-2 justify-end">
                  <button
                    ...
                    className="px-3 py-1.5 text-muted-foreground hover:text-secondary-foreground rounded-lg transition-colors text-sm"
                  >
                    Cancel
                  </button>
                  <button
            ...
            return (
              <motion.div
                ...
                className={`
                  ...
                  ${isEditing ? 'bg-muted border-primary-500' : 'bg-card/50 border-border hover:border-border'}
                `}
              >
                {isEditing ? (
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2 justify-end">
                      <button
                        ...
                        className="p-1.5 text-muted-foreground hover:text-secondary-foreground rounded transition-colors"
                      >
                        <X className="w-4 h-4" />
                      </button>
                      <button
