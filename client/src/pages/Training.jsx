  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
        ...
        <AnimatePresence mode="wait">
          ...
          {isConnecting && (
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-foreground mb-2">Connecting...</h2>
              <p className="text-muted-foreground">Setting up your training call</p>
            </motion.div>
          )}
          ...
          {isEnding && (
            ...
            >
              ...
              <h2 className="text-2xl font-bold text-foreground mb-2">Ending Call...</h2>
      ...
      <div className="glass-card border-b-0 border-x-0 rounded-none">
        <div className="max-w-4xl mx-auto px-4 py-2 flex items-center justify-center gap-6 text-xs text-muted-foreground">
