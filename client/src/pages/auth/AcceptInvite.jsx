      ...
      <div className="min-h-screen flex items-center justify-center bg-background px-4">
        ...
        >
          <div className="bg-card rounded-lg shadow-xl p-8 border border-border">
            ...
            <Link
              to="/auth/login"
              className="inline-flex items-center justify-center py-3 px-6 bg-foreground text-background hover:opacity-90 font-medium rounded-md transition-colors"
            >
              Go to Login
            </Link>
          </div>
          ...
          {isSignedIn && (
            ...
            >
              ...
              <button
                ...
                disabled={signingOut}
                className="w-full py-2 px-4 bg-amber-600 hover:bg-amber-700 disabled:bg-amber-600/50 text-foreground font-medium rounded-md transition-colors flex items-center justify-center gap-2 text-sm"
              >
                {signingOut ? (
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  {(error.includes('sign in') || error.includes('login page')) && (
                    <Link
                      to="/auth/login"
                      className="inline-flex items-center gap-1.5 mt-3 px-4 py-2 bg-foreground text-background hover:opacity-90 text-sm font-medium rounded-md transition-colors"
                    >
                      Go to Login Page
                    </Link>
                  )}
